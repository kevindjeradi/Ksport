...
class ScheduleComponent2 extends StatefulWidget {
  ...
  @override
  ScheduleComponent2State createState() => ScheduleComponent2State();
}

class ScheduleComponent2State extends State<ScheduleComponent2> {
